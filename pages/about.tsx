    ...
    <Layout>
      <ContentContainer>
        ...
        <p>
          ...
          make blinking color, moving text and other animation. Thats how i get
          interested into making website, starting from using{' '}
        ...
        <p>
          ...
          release their Frontend Framework <code>AngularJS</code> and there is a
          client who want their website build with <code>AngularJS</code> thus i
          learn AngularJS. Technology keep updating, many frontend framework and
          libraries appear such as <code>React</code> from facebook,{' '}
          <code>Angular (2+)</code> an entirely different angular framework than
          it&apos;s predecesor, then <code>VueJs</code> a framework made by
          community which is combined <code>AngularJS</code> ,{' '}
