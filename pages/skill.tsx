    ...
    <div className="d-flex justify-content-between contentContainer">
      <div className="d-flex flex-column w-50">
        ...
        <p>
          ...
          an assets management application using PHP, MySQL, JQuery and Oracle.
        </p>
        <p>
          My first Frontend project was to build a static Company Profile
          website, at that time there's no Frontend framework/library like Vue,
          Angular or React so i build it with just HTML, CSS & JQuery.
        </p>
        <p>
          ...
          multiple responsive web app that looks good in both mobile and desktop
          device, implementing lazy load for faster initial load.
        </p>
      </div>
